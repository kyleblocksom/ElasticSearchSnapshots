...
# Title: Register Snaphot Directory
# Date: January 11, 2023
#
# Objective: Create snapshot of target ES indices and store in Snapshot directory.
#
# API Reference: https://www.elastic.co/guide/en/elasticsearch/reference/current/snapshots-register-repository.html
